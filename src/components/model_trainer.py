...
class model_trainer:
    ...
    def initiate_model_trainer(self,train_array,test_array):
        try:
            ...
            params={
                     'RandomForest':{'n_estimators': [100,300,500],'max_depth':[13],'min_samples_split':[5],'random_state':[1]},
                     'GradientBoosting':{'n_estimators': [100,300,500],'max_depth':[13],'min_samples_split' :[5],'random_state':[1]}
                     }
